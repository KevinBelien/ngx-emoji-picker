...
import { Language, LocaleTranslations, Translations } from '../models';
...
export class TranslationService {
     ...
     * @readonly
     */
    readonly translations$: BehaviorSubject<LocaleTranslations> = new BehaviorSubject<LocaleTranslations>(new Map());
    ...
    loadTranslations = (language: Language, translations: { [key: string]: string }): void => {
        const mappedTranslations: LocaleTranslations = this.translations$.getValue();
     ...
     */
    getAllTranslations = (): LocaleTranslations => this.translations$.getValue();
     ...
     */
    getTranslationsByLanguage = (language: Language): Translations | undefined => this.getAllTranslations().get(language);
     ...
     */
    getTranslationsByCurrentLanguage = (): Translations | undefined => this.getTranslationsByLanguage(this.getLanguage());
     ...
     */
    getTranslationByKey = (key: string): string | undefined => this.getTranslationsByCurrentLanguage()?.get(key);
}
