...
@Component({
    template: `<div chPreventContextMenu [preventContextMenu]="preventContextMenu"></div>`,
    standalone: true,
...
describe('PreventContextMenuDirective', () => {
    ...
    beforeEach(() => {
        ...
        fixture = TestBed.createComponent(TestPreventContextMenuComponent);
    ...
    it('should create an instance of PreventContextMenuDirective', () => {
        const directive = fixture.debugElement.query(By.directive(PreventContextMenuDirective)).injector.get(PreventContextMenuDirective);
