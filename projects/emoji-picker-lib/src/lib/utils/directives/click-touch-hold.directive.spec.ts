...
@Component({
    template: ` <button id="test-button" chClickTouchHold [touchHoldTimeInMillis]="500" [dataAttribute]="'data-attribute'" (onClick)="onClick($event)" (onTouchHold)="onTouchHold($event)" data-attribute="test-value">Test Button</button> `,
    standalone: true,
...
describe('ClickTouchHoldDirective', () => {
    ...
    beforeEach(() => {
        ...
        buttonEl = fixture.debugElement.query(By.css('#test-button')).nativeElement as HTMLElement;
    ...
    it('should emit onTouchHold event after holding down', () => {
        ...
        expect(fixture.componentInstance.onTouchHold).toHaveBeenCalledWith({
    ...
    it('should not emit onTouchHold event if released before hold time', () => {
        ...
        expect(fixture.componentInstance.onTouchHold).not.toHaveBeenCalled();
    });
