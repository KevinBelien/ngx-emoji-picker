...
describe('ScreenService', () => {
            ...
            providers: [
                ScreenService,
                {
                    ...
                    useValue: {
                        ...
                        isMatched: jest.fn((query: string) => query === Breakpoints.Small)
                    }
                }
            ]
        }).compileComponents();
    ...
    it('should provide the correct initial breakpoint state', () => {
        ...
        jest.spyOn(breakpointObserver, 'isMatched').mockImplementation((query) => {
            switch (query) {
    ...
    it('should return the correct current breakpoint', () => {
        ...
        const result = screenService.getCurrentBreakpoint(breakpointStatus);
    ...
    it('should consolidate breakpoint status correctly', () => {
        ...
        const result = screenService.calculateBreakpointStatus(breakpointStatus);
