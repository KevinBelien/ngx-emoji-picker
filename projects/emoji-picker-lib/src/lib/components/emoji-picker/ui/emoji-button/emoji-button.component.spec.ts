...
@Component({
    ...
    standalone: true,
    template: `<ch-emoji-button [emoji]="emoji" [showSkintoneIndicator]="showSkintoneIndicator"></ch-emoji-button>`
})
...
describe('EmojiButtonComponent', () => {
    ...
    it('should display the emoji passed to it', () => {
        const buttonElement = fixture.debugElement.query(By.css('.ch-emoji'));
        expect(buttonElement.nativeElement.textContent).toBe('😀');
    });

    it('should not show the skintone indicator by default', () => {
        const buttonElement = fixture.debugElement.query(By.css('button'));
        expect(buttonElement.nativeElement.className).not.toContain('ch-emoji-variation-indicator');
    });
    ...
    it('should show the skintone indicator when showSkintoneIndicator is true', () => {
        ...
        const buttonElement = fixture.debugElement.query(By.css('button'));
        expect(buttonElement.nativeElement.className).toContain('ch-emoji-variation-indicator');
    });
