import { BreakpointObserver, Breakpoints, BreakpointState as CdkBreakpointState } from '@angular/cdk/layout';
import { inject, Injectable, Signal } from '@angular/core';
import { toSignal } from '@angular/core/rxjs-interop';
import { map } from 'rxjs';
import { Breakpoint, breakpoints, BreakpointState, BreakpointStatus } from '../models';
...
export class ScreenService {
    ...
    constructor() {
        this.breakpointState = toSignal(this.breakpointObserver.observe([Breakpoints.XSmall, Breakpoints.Small, Breakpoints.Medium, Breakpoints.Large]).pipe(map<CdkBreakpointState, BreakpointState>(() => this.calculateBreakpoints())), {
     ...
     */
    getCurrentBreakpoint = (breakpointStatus: BreakpointStatus): Breakpoint => breakpoints.find((breakpoint) => breakpointStatus[breakpoint]) || 'xs';
    /**
     ...
     */
    calculateBreakpointStatus = (breakpointStatus: BreakpointStatus): BreakpointStatus => ({
        xs: breakpointStatus.xs || breakpointStatus.sm || breakpointStatus.md || breakpointStatus.lg || breakpointStatus.xl,
        sm: breakpointStatus.sm || breakpointStatus.md || breakpointStatus.lg || breakpointStatus.xl,
        md: breakpointStatus.md || breakpointStatus.lg || breakpointStatus.xl,
     ...
     */
    isMobile = (): boolean => /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) || (navigator.userAgent.includes('Mac') && 'ontouchend' in document);
