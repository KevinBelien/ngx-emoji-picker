...
@Component({
    template: ` <button id="autofocus-button" chAutofocus [autofocus]="autofocus()">Click me</button> `,
    standalone: true,
...
describe('AutofocusDirective', () => {
    ...
    it('should add autofocus attribute when autofocus is true', () => {
        ...
        const buttonEl = fixture.debugElement.query(By.css('#autofocus-button'));
        expect(buttonEl.nativeElement.getAttribute('autofocus')).toBe('true');
    });
    ...
    it('should remove autofocus attribute when autofocus is false', () => {
        ...
        const buttonEl = fixture.debugElement.query(By.css('#autofocus-button'));
        expect(buttonEl.nativeElement.getAttribute('autofocus')).toBeNull();
    });
