...
@Component({
    ...
    standalone: true,
    template: `<ch-icon [cssClass]="cssClass" [iconPath]="iconPath" [height]="height" [width]="width" [viewBox]="viewBox"></ch-icon>`
})
...
describe('IconComponent', () => {
    ...
    it('should apply the CSS class to the SVG element', () => {
        ...
        const svgElement = fixture.debugElement.query(By.css('svg'));
        expect(svgElement.nativeElement.classList).toContain('custom-class');
    });
