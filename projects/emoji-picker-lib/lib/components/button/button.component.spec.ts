...
@Component({
    ...
    standalone: true,
    template: `<ch-button [disabled]="disabled" [icon]="icon" [label]="label" [focusStateEnabled]="focusStateEnabled" [activeStateEnabled]="activeStateEnabled" [hoverStateEnabled]="hoverStateEnabled"> </ch-button>`
})
...
describe('Button', () => {
    ...
    it('should render the button element', () => {
        const buttonElement = fixture.debugElement.query(By.css('ch-button'));
        expect(buttonElement).not.toBeNull();
    });

    it('should enabled by default', () => {
        fixture.detectChanges();
        const hostButtonEl = fixture.debugElement.query(By.css('ch-button'));

        const buttonEl = fixture.debugElement.query(By.css('.ch-button'));

        expect(buttonEl.nativeElement.disabled).toBe(false);
        expect(hostButtonEl.nativeElement.className).not.toContain('ch-disabled');
    });
    ...
    it('should be disabled when disabled is true', () => {
        ...
        expect(hostButtonEl.nativeElement.className).toContain('ch-disabled');
    });
    ...
    it('should display the icon to be on the left by default ', () => {
        ...
        const buttonEl = fixture.debugElement.query(By.css('.ch-button'));
        expect(buttonEl.nativeElement.children[0].className).toContain('ch-button-icon-left');
    });
    ...
    it('should display the icon on the right and have a label', () => {
        ...
        const buttonEl = fixture.debugElement.query(By.css('.ch-button'));
        expect(buttonEl.nativeElement.children[0].className).toContain('ch-button-icon-right');
        expect(buttonEl.nativeElement.children[1].textContent).toContain('ChitChat');
    });
    ...
    it('should be hoverable, focusable and active by default', () => {
        ...
        expect(buttonEl.nativeElement.className).not.toContain('ch-hover-state-disabled');

        buttonEl.nativeElement.focus();
        expect(document.activeElement).toBe(buttonEl.nativeElement);
        expect(buttonEl.nativeElement.className).not.toContain('ch-focus-state-disabled');

        buttonEl.nativeElement.click();
        expect(buttonEl.nativeElement.className).not.toContain('ch-active-state-disabled');
    });
    ...
    it('should not look focused when focusStateEnabled is false', () => {
        ...
        expect(buttonEl.nativeElement.className).toContain('ch-focus-state-disabled');
    });
    ...
    it('should not look active when activeStateEnabled is false', () => {
        ...
        expect(buttonEl.nativeElement.className).toContain('ch-active-state-disabled');
    });
    ...
    it('should not look hovered when hoverStateEnabled is false', () => {
        ...
        expect(buttonEl.nativeElement.className).toContain('ch-hover-state-disabled');
    });
});
