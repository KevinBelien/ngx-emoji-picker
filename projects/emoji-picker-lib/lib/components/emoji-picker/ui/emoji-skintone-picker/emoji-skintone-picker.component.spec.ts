...
@Component({
    ...
    standalone: true,
    template: `<ch-emoji-skintone-picker [emoji]="emoji" [emojiSizeInPx]="emojiSizeInPx" [emojiButtonSizeInPx]="emojiButtonSizeInPx" (onSelectionChanged)="handleSelectionChanged($event)"></ch-emoji-skintone-picker>`
})
...
describe('EmojiSkintonePickerComponent', () => {
    ...
    beforeEach(() => {
        ...
        fixture = TestBed.createComponent(TestEmojiSkintonePickerComponent);
    ...
    it('should render the emoji skintone picker element', () => {
        const pickerElement = fixture.debugElement.query(By.css('ch-emoji-skintone-picker'));
    ...
    it('should render emoji buttons based on skintones provided', () => {
        ...
        const emojiButtons = fixture.debugElement.queryAll(By.css('ch-emoji-button'));
    ...
    it('should emit event when an emoji button is clicked', () => {
        ...
        const emojiButtonDebugElement = fixture.debugElement.query(By.css('ch-emoji-button'));
        expect(emojiButtonDebugElement).not.toBeNull();

        if (emojiButtonDebugElement) {
            const containerDiv = fixture.debugElement.query(By.css('.skintone-picker-container'));
            ...
            expect(fixture.componentInstance.handleSelectionChanged).toHaveBeenCalled();
        }
    });
    ...
    it('should apply the correct emoji size and button size styles', () => {
        ...
        expect(parseFloat(pickerElement.nativeElement.style.getPropertyValue('--ch-emoji-fontsize'))).toBe(24);
        expect(parseFloat(pickerElement.nativeElement.style.getPropertyValue('--ch-emoji-buttonsize'))).toBe(48);
    });
    ...
    it('should not emit event on right-click', () => {
        ...
        if (emojiButtonDebugElement) {
            ...
            expect(fixture.componentInstance.handleSelectionChanged).not.toHaveBeenCalled();
        }
    });
});
